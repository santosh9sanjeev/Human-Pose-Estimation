...
import sys
sys.path.append(os.path.abspath("/home/santosh.sanjeev/CV-Lab/CV-assignment4-final/src/"))

from stacked_hourglass import hg1, hg2, hg8
from stacked_hourglass.model import hg
...
def main(args):
    ...
    if args.arch == 'hg1':
        ...
        model = hg(num_stacks=2, num_blocks=1, num_classes=16)#6730912
    else:
